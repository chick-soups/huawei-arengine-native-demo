...
public class DisplayRotationManager implements DisplayListener {
    ...
    /**
     * When the device is rotated, the size of the viewfinder and whether the viewfinder is rotated
     * need to be updated to correctly display the geometric information returned by AR Engine.
