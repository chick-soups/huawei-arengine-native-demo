...
namespace gWorldAr {
    ...
    public:
         ...
         */
        void RenderPointCloud(HwArSession *arSession, HwArFrame *arFrame,
         ...
         */
        void RenderPlanes(HwArSession *arSession, const glm::mat4 &viewMat, const glm::mat4 &projectionMat);
